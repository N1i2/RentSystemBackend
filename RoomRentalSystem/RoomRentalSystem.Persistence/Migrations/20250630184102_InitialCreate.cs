    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserFavoriteRooms", x => new { x.FavoriteRoomsId, x.User1Id });
                    table.ForeignKey(
                        name: "FK_UserFavoriteRooms_Rooms_FavoriteRoomsId",
                        column: x => x.FavoriteRoomsId,
                        principalTable: "Rooms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserFavoriteRooms_Users_User1Id",
                        column: x => x.User1Id,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserRoomComparisons", x => new { x.ComparisonsId, x.User2Id });
                    table.ForeignKey(
                        name: "FK_UserRoomComparisons_Rooms_ComparisonsId",
                        column: x => x.ComparisonsId,
                        principalTable: "Rooms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserRoomComparisons_Users_User2Id",
                        column: x => x.User2Id,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoomImages_RoomId_IsMain",
                table: "RoomImages",
                columns: new[] { "RoomId", "IsMain" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserFavoriteRooms_User1Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserRoomComparisons_User2Id",
                table: "UserRoomComparisons",
                column: "User2Id");
        }
